...
var baseLegacyAminoPubKey = { threshold: 0 };
exports.LegacyAminoPubKey = {
    ...
    decode: function (input, length) {
        ...
        var message = globalThis.Object.create(baseLegacyAminoPubKey);
        message.publicKeys = [];
    ...
    fromJSON: function (object) {
        ...
        if (object.publicKeys !== undefined && object.publicKeys !== null) {
            for (var _i = 0, _a = object.publicKeys; _i < _a.length; _i++) {
                var e = _a[_i];
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseLegacyAminoPubKey);
        message.publicKeys = [];
        if (object.threshold !== undefined && object.threshold !== null) {
