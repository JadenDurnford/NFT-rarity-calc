...
/* eslint-disable */
var mint_1 = require("../../../cosmos/mint/v1beta1/mint");
...
exports.QueryInflationRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseQueryInflationRequest);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    fromPartial: function (_) {
        var message = __assign({}, baseQueryInflationRequest);
        return message;
    },
    toJSON: function (_) {
        var obj = {};
...
exports.QueryInflationResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseQueryInflationResponse);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseQueryInflationResponse);
        if (object.inflation !== undefined && object.inflation !== null) {
...
exports.QueryAnnualProvisionsRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseQueryAnnualProvisionsRequest);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                default:
    ...
    fromPartial: function (_) {
        var message = __assign({}, baseQueryAnnualProvisionsRequest);
        return message;
    },
    toJSON: function (_) {
        var obj = {};
...
exports.QueryAnnualProvisionsResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseQueryAnnualProvisionsResponse);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseQueryAnnualProvisionsResponse);
        if (object.annualProvisions !== undefined &&
            object.annualProvisions !== null) {
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.Inflation = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryInflationResponse.decode(new minimal_1.Reader(data));
        });
    };
    QueryClientImpl.prototype.AnnualProvisions = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryAnnualProvisionsResponse.decode(new minimal_1.Reader(data));
        });
    };
