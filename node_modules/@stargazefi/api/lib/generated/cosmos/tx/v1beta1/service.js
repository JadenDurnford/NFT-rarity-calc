...
exports.GetTxsEventRequest = {
    ...
    decode: function (input, length) {
        ...
        var message = globalThis.Object.create(baseGetTxsEventRequest);
        message.events = [];
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseGetTxsEventRequest);
        message.events = [];
        if (object.events !== undefined && object.events !== null) {
            for (var _i = 0, _a = object.events; _i < _a.length; _i++) {
                var e = _a[_i];
...
exports.GetTxsEventResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseGetTxsEventResponse);
        message.txs = [];
        message.txResponses = [];
        while (reader.pos < end) {
            var tag = reader.uint32();
    ...
    fromJSON: function (object) {
        ...
        if (object.txResponses !== undefined && object.txResponses !== null) {
            for (var _b = 0, _c = object.txResponses; _b < _c.length; _b++) {
                var e = _c[_b];
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseGetTxsEventResponse);
        message.txs = [];
        message.txResponses = [];
        if (object.txs !== undefined && object.txs !== null) {
            for (var _i = 0, _a = object.txs; _i < _a.length; _i++) {
...
exports.BroadcastTxRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseBroadcastTxRequest);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseBroadcastTxRequest);
        if (object.txBytes !== undefined && object.txBytes !== null) {
...
exports.BroadcastTxResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseBroadcastTxResponse);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseBroadcastTxResponse);
        if (object.txResponse !== undefined && object.txResponse !== null) {
...
exports.SimulateRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseSimulateRequest);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseSimulateRequest);
        if (object.tx !== undefined && object.tx !== null) {
...
exports.SimulateResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseSimulateResponse);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseSimulateResponse);
        if (object.gasInfo !== undefined && object.gasInfo !== null) {
...
exports.GetTxRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseGetTxRequest);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseGetTxRequest);
        if (object.hash !== undefined && object.hash !== null) {
...
exports.GetTxResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseGetTxResponse);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseGetTxResponse);
        if (object.tx !== undefined && object.tx !== null) {
            message.tx = tx_1.Tx.fromPartial(object.tx);
        }
        else {
...
var ServiceClientImpl = /** @class */ (function () {
    ...
    ServiceClientImpl.prototype.Simulate = function (request) {
        ...
        return promise.then(function (data) { return exports.SimulateResponse.decode(new minimal_1.Reader(data)); });
    };
    ServiceClientImpl.prototype.GetTx = function (request) {
        ...
        return promise.then(function (data) { return exports.GetTxResponse.decode(new minimal_1.Reader(data)); });
    };
    ServiceClientImpl.prototype.BroadcastTx = function (request) {
        ...
        return promise.then(function (data) { return exports.BroadcastTxResponse.decode(new minimal_1.Reader(data)); });
    };
    ServiceClientImpl.prototype.GetTxsEvent = function (request) {
        ...
        return promise.then(function (data) { return exports.GetTxsEventResponse.decode(new minimal_1.Reader(data)); });
    };
