...
var baseProof = { total: Long.ZERO, index: Long.ZERO };
exports.Proof = {
    ...
    decode: function (input, length) {
        ...
        var message = globalThis.Object.create(baseProof);
        message.aunts = [];
    ...
    fromJSON: function (object) {
        ...
        if (object.aunts !== undefined && object.aunts !== null) {
            for (var _i = 0, _a = object.aunts; _i < _a.length; _i++) {
                var e = _a[_i];
...
exports.ValueOp = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseValueOp);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseValueOp);
        if (object.key !== undefined && object.key !== null) {
...
exports.DominoOp = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseDominoOp);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseDominoOp);
        if (object.key !== undefined && object.key !== null) {
            message.key = object.key;
        }
        else {
...
exports.ProofOp = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseProofOp);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseProofOp);
        if (object.type !== undefined && object.type !== null) {
...
exports.ProofOps = {
    ...
    decode: function (input, length) {
        var reader = input instanceof Uint8Array ? new minimal_1.Reader(input) : input;
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = globalThis.Object.create(baseProofOps);
        message.ops = [];
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON: function (object) {
        ...
        if (object.ops !== undefined && object.ops !== null) {
            for (var _i = 0, _a = object.ops; _i < _a.length; _i++) {
                var e = _a[_i];
    ...
    fromPartial: function (object) {
        var message = __assign({}, baseProofOps);
        message.ops = [];
        if (object.ops !== undefined && object.ops !== null) {
            for (var _i = 0, _a = object.ops; _i < _a.length; _i++) {
                var e = _a[_i];
